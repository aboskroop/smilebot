...
local function list_chats(msg)
  ...
  if hash then
    ...
    local text = '👥 <b>Robot Answer This Word </b>\n\n'
    for i=1, #names do
      text = text..' 💡 '..names[i]..'\n'
    end
    return text
...
local function run(msg, matches)
 if is_sudo(msg) then
  ...
  if matches[2] == 'clean' or matches[2] == 'حذف الجميع' then
  ...
  if matches[1] == 'chat' or matches[1] == 'الردود' then
